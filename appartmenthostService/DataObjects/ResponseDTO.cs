...
namespace apartmenthostService.DataObjects
{
    ...
    public static class RespH
    {
        ...
        public const string SRV_APARTMENT_PROPVAL_NOTFOUND = "SRV_APARTMENT_PROPVAL_NOTFOUND";
            // Значение свойства объекта не найдено

        public const string SRV_APARTMENT_REQUIRED = "SRV_APARTMENT_REQUIRED"; // Не заполнено обязательно поле

        public const string SRV_APARTMENT_INVALID_DICITEM = "SRV_APARTMENT_INVALID_DICITEM";
            // Не верное значение словаря
        ...
        public const string SRV_CARD_PROPVAL_NOTFOUND = "SRV_CARD_PROPVAL_NOTFOUND";
            // Значение свойства объекта не найдено
        ...
        public const string SRV_DICTIONARY_DEPENDENCY = "SRV_DICTIONARY_DEPENDENCY";
            // Объект не может быть изменен/удален т.к. зависит от другого объекта.  
        ...
        public const string SRV_DICTIONARYITEM_REQUIRED = "SRV_DICTIONARYITEM_REQUIRED";
            // Не заполнено обязательно поле

        public const string SRV_DICTIONARYITEM_EXISTS = "SRV_DICTIONARYITEM_EXISTS"; // Объект уже существует

        public const string SRV_DICTIONARYITEM_DEPENDENCY = "SRV_DICTIONARYITEM_DEPENDENCY";
            // Объект не может быть изменен/удален т.к. зависит от другого объекта.  
