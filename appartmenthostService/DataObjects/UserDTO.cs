...
namespace apartmenthostService.DataObjects
{
    public class UserDTO
    {
        ...
        [Metadata(Visible = false, RequiredForm = false, DataType = ConstDataType.Email)]
        ...
        // [GET][PUT] - {NN} - Пол
        [Metadata(Visible = true, RequiredForm = true, DataType = ConstDataType.List)]
        ...
        [Metadata(Visible = true, RequiredForm = false, DataType = ConstDataType.Email)]
        public string ContactEmail { get; set; }

        // [GET][PUT] - Предпочитаемый вид связи (Email/Телефон)
        [Metadata(Visible = true, RequiredForm = false, DataType = ConstDataType.List)]
        ...
        // [GET] - Рейтинг
        [Metadata(Visible = true, RequiredForm = false, DataType = ConstDataType.Rating)]
